...
degree                 : 0  , $                  ; Additive Legendre polynomial simultaneously fitted with continuum (-1 for no polynomials).
...
linelist_func          : 'lzifu_linelist', $     ; Name of linelist function
; Run mode
