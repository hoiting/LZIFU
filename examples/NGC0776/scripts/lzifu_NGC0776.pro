...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; Start settings ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
set = { Settings, $
only_1side             : 1                 , $  ; 0: 2-sided data. 1: 1-sided data
; For fitting
obj_name               : 'NGC0776'           , $  ; Object name
z                      :  0.016415           , $  ; Redshift
;;;;;;;;;;;;;;;;;;    Fitting range and masking    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
fit_ran                : [3800,7150],$          ; fitting range in A
...
resol_sigma            : 6./2.3548    , $       ; data resolution in Angstrom
...
supply_mask_2d        : 1 , $                   ; 1 = YES. Use external 2d mask. 0 = No. Don't use. Fit all spaxels possible. 
mask_2d_path          : '../data/', $                   ; path of the 2d mask file.
mask_2d_name          : 'NGC0776_starmask.fits.gz', $                   ; name of the 2d mask file. 
...
template_path          : '../../../stellar_models/miuscat_salpeter/',$ ;template path 
template_name          : ['cond_miuscat_m0.71.sav','cond_miuscat_p0.00.sav','cond_miuscat_p0.22.sav'], $ ; template names
...
resid_degree           : 5 , $                  ; Degree for fitting residual (one-sided).  -1 = don't fit. 
...
linelist_func          : 'lzifu_linelist_NGC0776', $     ; Name of linelist function
; Run mode
ncpu                   : 6 $                      ; Max number of CPUs used. 1 - 15  (> 1 for parallel processing)
}
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; end settings ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
